...
export default function Dashboard() {
 ...
 >
 <div>
 <h1 className="text-[1.65rem] font-extrabold text-lavender tracking-tight">قولیار</h1>
 ...
 className="flex h-11 w-11 items-center justify-center rounded-2xl bg-card text-accent shadow-card overflow-hidden"
 >
 {me?.user.photo_url ? (
 ...
 <p className="text-sm font-bold text-ink ">{me ? me.user.current_streak : "—"}</p>
 ...
 <Card className="flex items-center gap-4 bg-card shadow-card ">
 ...
 <p className="font-bold text-ink ">قول‌های شخصی</p>
 ...
 <div className="flex-1">
 <p className="font-bold text-ink ">قول‌های داده‌شده</p>
 ...
 <div className="flex-1">
 <p className="font-bold text-ink ">قول‌های گرفته‌شده</p>
