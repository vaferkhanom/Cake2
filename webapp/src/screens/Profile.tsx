...
export default function Profile() {
 ...
 <h1 className="text-xl font-extrabold flex-1 text-center text-lavender tracking-tight">پروفایل</h1>
 <div className="w-10" />
 </header>
 ...
 <p className="text-lg font-extrabold text-ink ">{me.user.display_name}</p>
 ...
 >
 <div
 className="rounded-card bg-card p-5 text-center shadow-card cursor-pointer select-none active:scale-95 transition-transform"
 ...
 >
 <p className="mb-4 text-sm font-bold text-ink ">عملکرد</p>
