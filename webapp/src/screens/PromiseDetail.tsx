...
export default function PromiseDetail() {
 ...
 <h1 className="text-xl font-extrabold flex-1 text-center text-lavender tracking-tight">جزئیات قول</h1>
 </header>
 ...
 <p className="text-[11px] text-ink-soft ">{promise.jalali_created_at}</p>
 </div>
 </div>
